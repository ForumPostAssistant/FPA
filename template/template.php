...
<h1><?php echo qText('This is a Test'); ?></h1>
...
<?php
    ...
    $phpenv['phpAPI']               = php_sapi_name();
         ...
         *****************************************************************************************/
        if ( ( $instance['instanceCONFIGURED'] == qText('Yes') ) AND ( $system['sysCURRUSER'] != $instance['configOWNER']['name'] ) AND ( $instance['configWRITABLE'] == qText('Yes') ) AND ( ( substr( $instance['configMODE'],0 ,1 ) < '6' ) OR ( substr( $instance['configMODE'],1 ,1 ) < '6' ) OR ( substr( $instance['configMODE'],2 ,1 ) <= '6' ) ) ) {
...
<?php
    ...
    echo '<div style="font-weight:bold;font-size:9px;text-transform:uppercase;width:24%;float:left;text-align:center;">MySQL Connection Type<br />';
        ...
        if ( @$instance['configDBTYPE'] ) {
            ...
            if ( ( @$snapshot['sqlSUP4SQL-i'] == qText('No') OR @$snapshot['sqlSUP4SQL-i'] == _FPA_U ) AND @$instance['configDBTYPE'] == 'mysqli') {
                    ...
                    <div class="half-section-information-right" style="width:340px;padding-top:10px;padding-bottom:10px;border-color:#CCC;box-shadow: inset 3px 3px 3px #C0C0C0;-webkit-box-shadow: inset 3px 3px 3px #C0C0C0;background-color:transparent!important;">
                        ...
                        <br />
                            ...
                            ?>
                                ...
                                <input style="font-size:9px;" type="radio" name="showProtected" value="2" <?php echo $selectshowProtected_2; ?> /><span class="warn-text"><?php echo _FPA_PRIVPAR .' ('. qText('Default') .')'; ?></span><br /><span style="line-height:8px;padding:0px;margin:0px;margin-left:15px;font-size:8px;"><?php echo _FPA_PRIVPARNOTE; ?></span><br />
            ...
            if ( @$_POST['doIT'] == '1' ) {
                ...
                echo "\n";
                    ...
                    if ( $instance['instanceCONFIGURED'] == qText('Yes') ) {
                        echo "\n";
                        echo _FPA_INSTANCE .' '. qText('Configured') .' ::  ';
                        echo $instance['instanceCONFIGURED'] .' | ';

                        if ( $instance['configWRITABLE'] == qText('Yes') ) { echo _FPA_WRITABLE .' ('; } else { echo _FPA_RO .' ('; }
                            ...
                            echo 'Offline: '. $instance['configOFFLINE'] .' | SEF: '. $instance['configSEF'] .' | SEF Suffix: '. $instance['configSEFSUFFIX'] .' | SEF ReWrite: '. $instance['configSEFRWRITE'] .' | GZip: '. $instance['configGZIP'] .' | Cache: '. $instance['configCACHING'] .' | FTP Layer: '. $instance['configFTP'] .' | SSL: '. $instance['configSSL'] .' | Error Reporting: '. $instance['configERRORREP'] .' | Site Debug: '. $instance['configSITEDEBUG'] .' | Language Debug: '. $instance['configLANGDEBUG'] .' | Default Access: '. $instance['configACCESS'] .' | Unicode Slugs: '. $instance['configUNICODE'] .' | ';
                                if ( $instance['configSITEHTWC'] == qText('Yes') ) { echo '.htaccess/web.config: '. $instance['configSITEHTWC']; }
                ...
                echo "\n";
                    ...
                    if ( $instance['instanceFOUND'] == qText('Yes') ) { echo '[color=#0000F0]'. $instance['cmsPRODUCT'] .' [b]'. $instance['cmsRELEASE'] .'.'. $instance['cmsDEVLEVEL'] .'[/b]-'. $instance['cmsDEVSTATUS'] .' ('. $instance['cmsCODENAME'] .') '. $instance['cmsRELDATE'] .'[/color]';
                    ...
                    echo '[color=#000000][b]'. _FPA_APP .' '. qText('Configured') .' :: [/b][/color]';
                    if ( $instance['instanceCONFIGURED'] == qText('Yes') ) {
                    echo '[color=#008000]'. qText('Yes') .'[/color] | ';

                        if ( $instance['configWRITABLE'] == qText('Yes') ) { echo '[color=#008000]'. _FPA_WRITABLE .'[/color] ('; } else { echo _FPA_RO .' ('; }
                    ...
                    echo '[b].htaccess/web.config:[/b] ';
                        ...
                        if ( $instance['configSITEHTWC'] == qText('No') AND $instance['configSEFRWRITE'] == '1' ) { echo '[color=orange]'. $instance['configSITEHTWC'] .' (ReWrite Enabled but no .htaccess?)[/color] | ';
                        } elseif ( $instance['configSITEHTWC'] == qText('Yes') ) { echo '[color=#008000]'. $instance['configSITEHTWC'] .'[/color] | ';
                        } elseif ( $instance['configSITEHTWC'] == qText('No') ) { echo '[color=orange]'. $instance['configSITEHTWC'] .'[/color] | '; }
                    ...
                    echo '[b]GZip:[/b] '. $instance['configGZIP'] .' | [b]Cache:[/b] '. $instance['configCACHING'] .' | [b]FTP Layer:[/b] '. $instance['configFTP'] .' | [b]SSL:[/b] '. $instance['configSSL'] .' | [b]Error Reporting:[/b] '. $instance['configERRORREP'] .' | [b]Site Debug:[/b] '. $instance['configSITEDEBUG'] .' | ';
                        ...
                        echo '[b]'. _FPA_DB .' '. _FPA_CREDPRES .':[/b] ';
                            if ( $instance['configDBCREDOK'] == qText('Yes') ) { echo '[color=#008000]'; } else { echo '[color=#800000]'; }
                    ...
                    echo '[color=#000000][b]'. _FPA_HOST .' '. _FPA_CFG .' :: [/b][/color] [b]OS:[/b] '. $system['sysPLATOS'] .' |  [b]OS '._FPA_VER.':[/b] '. $system['sysPLATREL'] .' | [b]'. _FPA_TEC .':[/b] '. $system['sysPLATTECH'] .' | [b]'. _FPA_WSVR .':[/b] '. $system['sysSERVSIG'] .' | [b]Encoding:[/b] '. $system['sysENCODING'] .' | [b]'. _FPA_DROOT .':[/b] '. $system['sysDOCROOT'] .' | [b]'. _FPA_SYS .' TMP '. _FPA_WRITABLE .':[/b] ';
                        if ( $system['sysTMPDIRWRITABLE'] == qText('Yes') ) { echo '[color=#008000]'; } else { echo '[color=#800000]'; }
                    ...
                    echo '[b]Session Path '. _FPA_WRITABLE .':[/b] ';
                        if ( $phpenv['phpSESSIONPATHWRITABLE'] == qText('Yes') ) { echo '[color=#008000]'. $phpenv['phpSESSIONPATHWRITABLE'] .'[/color] | '; } elseif ( $phpenv['phpSESSIONPATHWRITABLE'] == qText('No') ) { echo '[color=#800000]'. $phpenv['phpSESSIONPATHWRITABLE'] .'[/color] | '; } else { echo '[color=orange]'. $phpenv['phpSESSIONPATHWRITABLE'] .'[/color] | '; }
                    ...
                    } elseif ( @$database['dbERROR'] != qText('No') ) { echo '[b]'. _FPA_ECON .':[/b] ';
...
//                                echo "\r\n";
                    ...
                    echo '[color=#000000][b]'. _FPA_PHPEXT_TITLE .' :: [/b][/color]';
                        ...
                        echo "\r\n";
                        echo '[b]'. _FPA_POTOI .':[/b] ';
                            if ( $phpenv['phpOWNERPROB'] == qText('Yes') ) { echo '[color=#800000]'; } elseif ( $phpenv['phpOWNERPROB'] == qText('No') ) { echo '[color=#008000]'; } else { echo '[color=orange]'; }
...
<?php
    ...
    echo '<div class="half-section-container" style="z-index:1;">'; // start half-section container
        ...
        if ( $instance['instanceFOUND'] != qText('Yes') ) {
            ...
            echo _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $instance['ARRNAME'].' '. _FPA_TESTP;
        ...
        echo '<div class="" style="width:99%;margin: 0px auto;clear:both;margin-bottom:10px;">';
            ...
            if ( $instance['instanceCONFIGURED'] == qText('Yes') AND $instance['configVALIDFOR'] != _FPA_U ) {
                ...
                echo '<div class="row-content-container nothing-to-display" style="">';
                echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">';
                echo _FPA_CFG .' '. qText('Not Found') .' '. _FPA_OR .' '. _FPA_NVALID .'<br /> '. qText('No') .' '. $instance['ARRNAME'] .' '. _FPA_TESTP;
                echo '</div>';
                echo '</div>';
            }
...
<?php
    ...
    echo '<div class="half-section-container" style="">'; // start half-section container
        ...
        echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom:1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;">'. _FPA_CON .' '. _FPA_TO .' '. @$instance['configDBTYPE'] .':<div style="line-height:11px;text-transform:none!important;float:right;font-size:9px;font-weight:normal;width:60%;background-color:#fff;text-align:right;padding:1px;padding-top:0px;border-right: 1px solid #42AEC2;border-left: 1px solid #42AEC2;1px solid #ccebeb;">';
            ...
            if ( $database['dbDOCHECKS'] == qText('No') ) {
                echo '<span class="warn-text">&nbsp;'. _FPA_NOA .', '. qText('Not Configured') .'&nbsp;</span>';

            } elseif ( @$database['dbERROR'] == qText('No') ) {
                echo '<span class="ok">&nbsp;'. qText('Yes') .', '. qText('Connected') .'&nbsp;</span>';

            } elseif ( @$database['dbERROR'] != qText('No') ) {
                echo '<span class="alert-text">&nbsp;'. qText('No') .', '. _FPA_ER .'&nbsp;</span>';
            }
        ...
        echo '<div style="line-height:10px;font-size:8px;color:#404040;text-shadow: #fff 1px 1px 1px;width:99%;border-bottom: 1px solid #ccebeb;font-weight:bold;padding:1px;padding-top:0px;padding-right:0px;padding-bottom:2px;text-transform:uppercase;"><span class="alert-text" style="font-size:8px;">'. _FPA_MISSINGCRED .':</span> ';
            ...
            if ( @$instance['configDBTYPE'] == '' ) { echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;<b>'. _FPA_CONT .'</b> '. qText('Not Found') .'</span>'; }
            if ( @$instance['configDBHOST'] == '' ) { echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;MySQL <b>'. _FPA_HNAME .'</b> '. qText('Not Found') .'</span>'; }
            if ( @$instance['configDBPREF'] == '' ) { echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;<b>'. _FPA_TBL .' Prefix</b> '. qText('Not Found') .'</span>'; }
            if ( @$instance['configDBUSER'] == '' ) { echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;'. _FPA_DB .' <b>'. _FPA_USER .'</b> '. qText('Not Found') .'</span>'; }
            if ( @$instance['configDBPASS'] == '' ) { echo '<span class="warn-text" style="font-size:9px;font-weight:normal;text-transform:none;">&nbsp;'. _FPA_DB .' <b>'. _FPA_PASS .'</b> '. qText('Not Found') .'</span>'; }
        ...
        echo '<div class="" style="width:99%;margin: 0px auto;clear:both;margin-bottom:10px;">';
            ...
            if ( $database['dbDOCHECKS'] == qText('Yes') AND @$database['dbERROR'] == qText('No') ) {
                ...
                echo '<div class="row-content-container nothing-to-display" style="">';
                echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. qText('Not Connected') .'<br />'. qText('No') .' '. $database['ARRNAME'] .' '. _FPA_PERF .' '. _FPA_TESTP .'</div>';
                echo '</div>';
            }
    ...
    if ( $showTables == '1' ) {
        ...
        echo '</div>';
            ...
            if ( $instance['instanceFOUND'] == qText('Yes') AND @$database['dbERROR'] == qText('No') ) {
                ...
                echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. qText('Not Connected') .', '. qText('No') .' '. $tables['ARRNAME'] .' '. _FPA_TESTP .'</div>';
                echo '</div>';
            }
...
<?php
    ...
    // this is the content area
        ...
        echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
        echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $modecheck['ARRNAME'] .' '. _FPA_TESTP .'</div>';
        echo '</div>';
    }
...
//                            echo $key;  // display the folder name
            ...
            echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
            echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $elevated['ARRNAME'] .' '. _FPA_TESTP .'</div>';
            echo '</div>';
        }
...
<?php
    if ( $showComponents == '1' ) {
        ...
        if ( $instance['instanceFOUND'] == qText('Yes') ) { // an instance wasn't found in the initial checks, so no folders to check
            ...
            echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
            echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $component['ARRNAME'] .' '. _FPA_TESTP .'</div>';
            echo '</div>';
        }
        ...
        echo '<div class="column-title" style="width:20%;float:left;text-align:left;">'. _FPA_TNAM .'</div>';
        echo '<div class="column-title" style="width:14%;float:left;text-align:center;">'. _FPA_VER .'</div>';
        echo '<div class="column-title" style="width:14%;float:left;">'. _FPA_CRED .'</div>';
        echo '<div class="column-title" style="width:14%;float:left;">'. _FPA_AUTH .'</div>';
        echo '<div class="column-title" style="width:19%;float:left;">'. _FPA_ADDR .'</div>';
        echo '<div class="column-title" style="width:10%;float:right;text-align:center;">'. _FPA_STATUS .'</div>';
        echo '<div style="clear:both;"></div>';
...
<?php
    if ( $showModules == '1' ) {
        ...
        if ( $instance['instanceFOUND'] == qText('Yes') ) { // an instance wasn't found in the initial checks, so no folders to check
            ...
            echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
            echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $module['ARRNAME'] .' '. _FPA_TESTP .'</div>';
            echo '</div>';
        }
...
<?php
    if ( $showPlugins == '1' ) {
        ...
        if ( $instance['instanceFOUND'] == qText('Yes') ) { // an instance wasn't found in the initial checks, so no folders to check
            ...
            echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
            echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $plugin['ARRNAME'] .' '. _FPA_TESTP .'</div>';
            echo '</div>';
        }
...
<?php
        ...
        if ( $instance['instanceFOUND'] == qText('Yes') ) { // an instance wasn't found in the initial checks, so no folders to check
            ...
            echo '<div style="text-align:center;border-bottom:1px dotted #C0C0C0;width:99%;margin: 0px auto;padding-top:1px;padding-bottom:1px;clear:both;font-size: 11px;">';
            echo '<div class="warn" style=" margin-top:10px;margin-bottom:10px;">'. _FPA_INSTANCE .' '. qText('Not Found') .', '. qText('No') .' '. $template['ARRNAME'] .' '. _FPA_TESTP .'</div>';
            echo '</div>';
        }
